...
CREATE TABLE [dbo].[Distritos](
	[distritoId] [bigint] IDENTITY(1,1) NOT NULL,
	[provinciaId] [tinyint] NOT NULL,
...
CREATE TABLE [dbo].[Espacios_Estacionamientos](
	...
	[estacionamientoId] [bigint] NOT NULL,
...
CREATE TABLE [dbo].[Estacionamientos](
	[estacionamientoId] [bigint] IDENTITY(1,1) NOT NULL,
	[tipoEstacionamiento] [smallint] NULL,
	[deshabilitado] [bit] NOT NULL,
	[ubicacion] [bigint] NULL,
	[nombre] [nvarchar](200) NOT NULL,
	[formaAcceso] [nvarchar](500) NOT NULL,
	[cantEspacios] [bigint] NOT NULL,
	[cantEspaciosEspeciales] [bigint] NULL,
	[cantEspaciosJefaturas] [bigint] NULL,
	[cantEspaciosVisitantes] [bigint] NULL,
	[cantEspaciosOficiales] [bigint] NULL,
...
CREATE TABLE [dbo].[Permisos_Por_Usuario](
	[permisoUsuarioId] [bigint] NOT NULL,
	[usuarioId] [bigint] NOT NULL
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[TiposFuncionarios](
	[tipoFuncionarioId] [bigint] IDENTITY(1,1) NOT NULL,
